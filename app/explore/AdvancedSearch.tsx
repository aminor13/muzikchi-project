...
.select(id, username, display_name, profile_image_url, is_complete, ready_for_cooperate, looking_for_musician, roles, province, city, profile_instruments( instrument_id ))
.eq('is_complete', true)
.eq('is_admin', false);
